...
const Form = () => {
    ...
    return (
        <Grid container spacing={2}>
            ...
            <Grid item xs={6}>
                <TextField type="dater" label="Date" fullWidth value={formData.date} onchange={(e) => setFromData({ ...formData, date: formatDate(e.target.value) })} />
            </Grid>
